...
Durable calapres decisions live in the `decisions` directory. Project decisions belong in this
repository, not in `ai-operating-system` and not in launcher-local memory.
...
- [0003 — Calapres SKU format](decisions/0003-calapres-sku-format.md)
